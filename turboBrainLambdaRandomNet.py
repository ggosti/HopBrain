...
for lambd in lambdas:
    ...
    plt.savefig('structure'+str(lambd)+'RandomNet.pdf')

df = pd.DataFrame(
    {'lambdas': lambdas,
     'alphas': alphas
    })
df.to_csv('parametersRandomNet.csv', index=False)
...
df0 = pd.DataFrame(
    {'alphaRuns':alphaSrRuns,
     'lambdas':lambdasRuns,
      ...
      'run':runsList})
df0.to_csv('parametersRunsRandomNet.csv', index=False)
